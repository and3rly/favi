<template>
	<div class="alert alert-info">
		...
		En la columna de la izquierda se muestran las bodegas asignadas <b>(se puede remover)</b>. Y en la columna de la derecha puede seleccionar las bodegas que se desean agregar.
	</div>
