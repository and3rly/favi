		...
		<div class="row g-2 mb-4">
			<div class="col-sm-6">
				...
				<input 
					type="text" 
					class="form-control"
					placeholder="Nombre del motivo de anulación" 
					v-model="form.nombre"
				>
			</div>
		</div>		
...
<script>
	...
	export default {
		name:"Motivo_anulacion_pedidoForm",
		...
		created() {
			...
			if (this.Motivo_anulacion_pedido) {
				this.pk = this.Motivo_anulacion_pedido.id
				this.setDatosForm(this.Motivo_anulacion_pedido);
			}
		},
		methods: {
			setForm() {
