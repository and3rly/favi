<template>
	<div class="d-flex align-items-center mb-4">
		<h1 class="page-header mb-0">
			<i class="fas fa-road fa-sm me-2 ms-1"></i>Ruta
		</h1>
...
<script>
    ...
    import RutaLista from '@/views/mnt/ruta/RutaLista.vue'
	import RutaForm from '@/views/mnt/ruta/RutaForm.vue'
	...
	export default {
		...
		mounted() {
			this.modal = new this.$modal(document.getElementById('mdlRuta'));
		},
		created() {
